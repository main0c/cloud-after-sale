		...
		methods: {
			...
			* */
			getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
				var listUrl = "sealseservice001";//默认加载全部工单列表
				if(this.i == 0){
					//全部工单
					listUrl = "sealseservice001";
				}else if(this.i == 1){
					//待派工
					listUrl = "sealseservice002";
				}else if(this.i == 2){
					//待评价
					listUrl = "sealseservice007";
				}else if(this.i == 3){
					//待审核
					listUrl = "sealseservice008";
				}else if(this.i == 4){
					//已完工
					listUrl = "sealseservice009";
				}
				var param = {
					limit: pageSize,
					page: pageNum,
